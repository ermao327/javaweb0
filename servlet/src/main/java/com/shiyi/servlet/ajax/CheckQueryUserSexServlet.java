...
@WebServlet(name = "CheckQueryUserSexServlet", value = "/CheckQueryUserSexServlet")
public class CheckQueryUserSexServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            final List<User> list = new UserService().checkquerySex(sex,m,3);
